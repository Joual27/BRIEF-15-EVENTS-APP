...
@section('content')
    ...
    <body class="h-screen bg-pink-100">
    <div class="flex">
        <aside class="flex">
                ...
                <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <div class="flex gap-5">
                            ...
                            <div class="relative bg-gradient-to-b from-pink-300 w-[360px] h-[130px] pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow-md rounded-lg overflow-hidden">
                                <dt>
                                    ...
                                    <p class="ml-16 text-sm font-medium text-gray-500 truncate">Overall organizers</p>
                                </dt>
                ...
                <table id="table" class="w-[50%] mx-auto">
                    ...
                    @foreach($events as $event)
                        ...
                        <td class="flex gap-3 justify-center">
                            <a href="{{route('event.validate',$event)}}">
                            ...
                            <a href="{{route('event.reject',$event)}}">
